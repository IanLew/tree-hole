...
router.post('/letters', LetterController.getAllLetters)  // 分页获取信笺列表/回复
...
router.post('/letterlogs', LetterlogController.getAllLetterlogs)  // 分页获取所有信笺行为记录
...
router.post('/token/cusers', BuserController.getUsers)  // 官网分页获取获取所有用户
